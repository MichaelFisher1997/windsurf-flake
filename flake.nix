      ...
      in
      {
        packages = {
          windsurf = pkgs.stdenv.mkDerivation rec {
            ...
            src = pkgs.fetchurl {
              url = "https://windsurf-stable.codeiumdata.com/linux-x64/stable/c1893363f18838235dfeff2c06556d0678e60704/Windsurf-linux-x64-1.13.8.tar.gz";
              sha256 = "14wgk1352z5rcnc7z4h0a7zjrsb6fql0a39v9q97nc3iipwxd9ch";
            };
